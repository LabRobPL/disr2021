...
class RimlessWheelContinuousState final
 ...
 public:
  ...
  RimlessWheelContinuousState<T>* DoClone() const final {
  ...
  RimlessWheelContinuousState<T> with_theta(const T& theta) const {
  ...
  DRAKE_VECTOR_GEN_NODISCARD
  RimlessWheelContinuousState<T> with_thetadot(const T& thetadot) const {
    RimlessWheelContinuousState<T> result(*this);
