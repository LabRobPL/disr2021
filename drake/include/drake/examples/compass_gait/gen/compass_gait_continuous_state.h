...
class CompassGaitContinuousState final : public drake::systems::BasicVector<T> {
 public:
  ...
  CompassGaitContinuousState<T>* DoClone() const final {
  ...
  CompassGaitContinuousState<T> with_stance(const T& stance) const {
  ...
  DRAKE_VECTOR_GEN_NODISCARD
  CompassGaitContinuousState<T> with_swing(const T& swing) const {
    CompassGaitContinuousState<T> result(*this);
  ...
  DRAKE_VECTOR_GEN_NODISCARD
  CompassGaitContinuousState<T> with_stancedot(const T& stancedot) const {
    CompassGaitContinuousState<T> result(*this);
  ...
  DRAKE_VECTOR_GEN_NODISCARD
  CompassGaitContinuousState<T> with_swingdot(const T& swingdot) const {
    CompassGaitContinuousState<T> result(*this);
