...
class BicycleCarState final : public drake::systems::BasicVector<T> {
 public:
  ...
  SetToNamedVariables() {
    this->set_Psi(symbolic::Variable("Psi"));
    this->set_Psi_dot(symbolic::Variable("Psi_dot"));
    this->set_beta(symbolic::Variable("beta"));
    this->set_vel(symbolic::Variable("vel"));
    this->set_sx(symbolic::Variable("sx"));
    this->set_sy(symbolic::Variable("sy"));
  }
