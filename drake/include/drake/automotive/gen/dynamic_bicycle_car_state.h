...
class DynamicBicycleCarState final : public drake::systems::BasicVector<T> {
 public:
  ...
  SetToNamedVariables() {
    this->set_p_LoCp_x(symbolic::Variable("p_LoCp_x"));
    this->set_p_LoCp_y(symbolic::Variable("p_LoCp_y"));
    this->set_yaw_LC(symbolic::Variable("yaw_LC"));
    this->set_v_LCp_x(symbolic::Variable("v_LCp_x"));
    this->set_v_LCp_y(symbolic::Variable("v_LCp_y"));
    this->set_yawDt_LC(symbolic::Variable("yawDt_LC"));
  }
