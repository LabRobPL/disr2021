...
class DynamicBicycleCarParams final : public drake::systems::BasicVector<T> {
 public:
  ...
  SetToNamedVariables() {
    ...
    this->set_izz(symbolic::Variable("izz"));
    this->set_c_alpha_f(symbolic::Variable("c_alpha_f"));
    this->set_c_alpha_r(symbolic::Variable("c_alpha_r"));
    this->set_mu(symbolic::Variable("mu"));
    this->set_Lf(symbolic::Variable("Lf"));
    this->set_Lb(symbolic::Variable("Lb"));
    this->set_p_LoCp_z(symbolic::Variable("p_LoCp_z"));
